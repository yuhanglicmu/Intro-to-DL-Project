...
def main():
    ...
    parser.add_argument('--input_wavs_dir', default='/lab_data/barblab/AlexP/will/train-dl/test/')
    parser.add_argument('--output_dir', default='generated_files')
    parser.add_argument('--checkpoint_file', default = '/lab_data/barblab/AlexP/will/train-dl/chkpt/g_00070000')#required=True)
